...
WalletService.prototype._sendMultiPayment = function (wallet, opts, cb) {
  ...
  if (opts.app == 'payment')  opts.params.asset = asset;
  ...
  async.series([
    ...
    function (next) {
      ...
      getChangeAddress(wallet, function (err, address, isNew) {
        ...
        isNewAddress = isNew;
        if (opts.app == 'payment')  opts.params.change_address = address.address;
        return next();
      });
    },
 ...
 *
 * @param {Object} opts.minTs [Optional] - (defaults to 0)
 * @param {Object} opts.maxTs [Optional] - (defaults to now)
