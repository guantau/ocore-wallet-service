...
Address.create = function(opts) {
  ...
  x.signingPaths = opts.signingPaths || {};
  x.isChange = opts.isChange || false;
  ...
  if (opts.definition) {
    ...
    x.signingPaths = Address._getSigningPaths(opts.definition);
  }
...
Address.fromObj = function(obj) {
  ...
  x.signingPaths = obj.signingPaths;
  x.coin = obj.coin || Defaults.COIN;
  x.network = obj.network || Defaults.NETWORK;
  x.isChange = obj.isChange || false;
...
Address._getSigningPaths = function(definition) {
...
Address._deriveAddress = function(definitionTemplate, copayers, path) {
  ...
  var signingPaths = Address._getSigningPaths(definition);
