        ...
        server.createAddress({}, function(err, address) {
          ...
          server._notify('NewIncomingTx', {
            ...
            setTimeout(function() {
              ...
              args[0].body.notification.body.should.contain('0.0123');

              args[1].body.notification.title.should.contain('New payment received');
              args[1].body.notification.body.should.contain('12,300,000');

              args[2].body.notification.title.should.contain('New payment received');
              args[2].body.notification.body.should.contain('12,300,000');
              done();
            }, 1000);
          });
        });
  ...
  describe('joinWallet', function() {
    ...
    it('should notify copayers when a new copayer just joined into your wallet except the one who joined', function(done) {
      async.eachSeries(_.range(3), function(i, next) {
        var dxpri = Bitcore.HDPrivateKey(TestData.copayers[i].xPrivKey_1H);
